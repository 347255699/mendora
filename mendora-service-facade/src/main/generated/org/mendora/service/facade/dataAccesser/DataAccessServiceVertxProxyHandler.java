...
public class DataAccessServiceVertxProxyHandler extends ProxyHandler {
  ...
  public DataAccessServiceVertxProxyHandler(Vertx vertx, DataAccessService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public DataAccessServiceVertxProxyHandler(Vertx vertx, DataAccessService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public DataAccessServiceVertxProxyHandler(Vertx vertx, DataAccessService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
