...
public class DataAccessServiceVertxEBProxy implements DataAccessService {
  ...
  public DataAccessServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public DataAccessServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
