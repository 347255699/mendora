...
public class WebVerticle extends DefaultVerticle {
    ...
    public void start() {
        ...
        injector = injector.createChildInjector(new WebBinder(router), serviceProxyBinder);
        ...
        scanner.scan(configHolder.property(WebConst.WEB_ROUTE_PACKAGE), injector, WebVerticle.class.getClassLoader());
    }
}
